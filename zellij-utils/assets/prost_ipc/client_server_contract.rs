...
#[derive(Clone, PartialEq, ::prost::Oneof)]
    pub enum ActionType {
        ...
        GoToNextSideTab(super::GoToNextSideTabAction),
        #[prost(message, tag="141")]
        GoToPreviousSideTab(super::GoToPreviousSideTabAction),
        #[prost(message, tag="142")]
        GoToSideTab(super::GoToSideTabAction),
        #[prost(message, tag="143")]
        NewSideTab(super::NewSideTabAction),
        #[prost(message, tag="144")]
        CloseSideTab(super::CloseSideTabAction),
        #[prost(message, tag="145")]
        ToggleSideBar(super::ToggleSideBarAction),
    }
}
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct GoToNextSideTabAction {
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct GoToPreviousSideTabAction {
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct GoToSideTabAction {
    #[prost(uint32, tag="1")]
    pub index: u32,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct NewSideTabAction {
    #[prost(string, optional, tag="1")]
    pub name: ::core::option::Option<::prost::alloc::string::String>,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct CloseSideTabAction {
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
